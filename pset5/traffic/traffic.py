...
def load_data(data_dir):
    ...
    # Read files into "images" and "labels""
    # Inner directory is a number ranging from 0 to NUM_CATEGORIES - 1
    for i in range(NUM_CATEGORIES):

        # Get list of files (images) in inner directory
        ...
        for file in files:
            ...
            # Add resized image and its directory to lists
            images.append(res)
            labels.append(i)
...
def get_model():
    ...
    model = tf.keras.models.Sequential([
        ...
        tf.keras.layers.Conv2D(36, (3, 3), activation="relu", input_shape=img_shape),
